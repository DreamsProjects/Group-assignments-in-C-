...
namespace Medium_Sudoku
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Hej! Det här programmet löser svårare sudoku problem");
            Console.WriteLine("\nSkriv in ditt svåra Sudoku problem genom att ange en siffra(1-9) för varje cell");
